...
add_action( 'tgmpa_register', 'mobile_app_manager_for_connections_register_required_plugins' );

function mobile_app_manager_for_connections_register_required_plugins() {

	$plugins = array(

		array(
			'name'         => 'Mobile App Manager', // The plugin name.
			'slug'         => 'wp-local-app', // The plugin slug (typically the folder name).
			'source'       => 'https://tinyscreenlabs.com/wp-content/plugins/tsl-traffic-manager/updates/connections/wp-local-app.zip', // The plugin source.
			'required'     =>  false, // If false, the plugin is only 'recommended' instead of required.
			'external_url' => 'https://tinyscreenlabs.com/?tslref=connections', // If set, overrides default API URL and points to an external URL.
		),
			array(
			'name'         => 'Connections Business Directory', // The plugin name.
			'slug'         => 'connections', // The plugin slug (typically the folder name).
			'source'       => 'https://wordpress.org/plugins/connections/', // The plugin source.
			'required'     =>  false, // If false, the plugin is only 'recommended' instead of required.
	...
	$config = array(
		'id'           => 'mobile_app_manager_for_connections',         // Unique ID for hashing notices for multiple instances of TGMPA.
	...
	mobile_app_manager_for_connections_tgmpa( $plugins, $config );
}
...
if ( ! function_exists( 'mobile_app_manager_for_connections_tgmpa' ) ) {
	/**
	 ...
	 */
	function mobile_app_manager_for_connections_tgmpa( $plugins, $config = array() ) {
